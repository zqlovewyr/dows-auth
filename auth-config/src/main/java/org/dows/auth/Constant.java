...
public class Constant {
    ...
    public static final String NUMBER_CODE_KEY = "dows:number:code:";
    public static final String MOBILE_CODE_KEY = "dows:mobile:code:";
    public static final String AUTHENTICATION_TOKEN = "dows:token:";
